<template>
  <div class="flex flex-col items-center justify-center">
    <h1 class="text-3xl font-bold mb-8">Withdraw</h1>
    <form
...
const submitForm = async () => {
  ...
  const res = await withdraw(operator.value, user.value, uid.value, amount.value, trade_no.value, secret.value, currency.value)
